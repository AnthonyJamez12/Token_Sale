...
contract('ARMSJARB_C_TOKEN', function(accounts){
    ...
    it('initializes the contract with the correct values', function(){
        return ARMSJARB_C_TOKEN.deployed().then(function(instance){
            ...
            assert.equal(name, 'Armsjarb Token', 'has the correct name');
            return tokenInstance.symbol();
        }).then(function(symbol){
            assert.equal(symbol, 'AMJ', 'has the correct symbol')
            return tokenInstance.standard();
        }).then(function(standard){
            assert.equal(standard, 'Armsjarb Token v1.0', 'has the correct standard')
    ...
    it('approves tokens for delefated transfer', function(){
        return ARMSJARB_C_TOKEN.deployed().then(function(instance){
            tokenInstance = instance;
            ...
            assert.equal(allowance.toNumber(), 100, 'stores the allowance for delegated trasfer');
        });
    });
